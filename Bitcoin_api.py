...
def fetch_bitcoin_data(symbol, market):
    load_dotenv()
...
df = fetch_bitcoin_data(symbol, market)

# Check if the DataFrame is valid
if df is None:
    raise ValueError("Data fetching returned None. Please check the fetch_bitcoin_data function.")
if df.empty:
    raise ValueError("Data fetching returned an empty DataFrame. Please check the fetch_bitcoin_data function.")
