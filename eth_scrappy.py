...
def get_ethereum_news():
    # URL of the webpage to scrape
    base_url = 'https://www.ft.com/ethereum?page='
...
# Usage
ethereum_titles_df = get_ethereum_news()

# Print the DataFrame
if ethereum_titles_df is not None:
    print(ethereum_titles_df)
